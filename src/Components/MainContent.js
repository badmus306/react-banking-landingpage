    ...
    return (
        <MainContentStyled >
            ...
            <div className="content">
                <div className="left">
                    <SmallHeading title={'Banking with us got easier'} identifier={'Before'} />
                    <h1>
                        All Currency in Centralized place
                        The Best Place to Collect , Buy and Sell <span className='GradientText'>Great Notes </span>
                    </h1>
                    <p>

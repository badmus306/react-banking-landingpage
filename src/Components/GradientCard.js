...
const GradientCardStyled = styled.div`
    ...
    @keyframes colors {
        0%{
            background: linear-gradient(130deg,#2f2fa2,#f64c72 50%,#2f2fa2);
        }
        50%{
            background: linear-gradient(90deg, #fc4445 0%, #cafafe 100%);
        }
        70%{
            background: linear-gradient(130deg,#daad86  0%, #659dbd 100%);
        }
        100%{
            background: linear-gradient(130deg,#2f2fa2,#f64c72 50%,#2f2fa2);;
        }
